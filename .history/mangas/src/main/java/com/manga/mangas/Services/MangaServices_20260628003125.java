...
public class MangaServices {
    ...
    public MangaDTO convertirMangaDTO(Manga manga){
        ...
        // LLAMADA DIRECTA (Sin red, sin puertos, sin errores de conexión)
        try {
            // Asegúrate de que este método exista en DemografiaServices
            String infoDemografia = DemografiaServices.buscarPorId(manga.getIdDemografia()).getNombre();
            dto.setInformacionExtra(infoDemografia);
        } catch (Exception e) {
