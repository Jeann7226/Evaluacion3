-- 1. CREACIÓN DE TABLAS DE RELACIONES (Requisito para tus @ManyToOne)
CREATE TABLE autor (
...
-- 2. CREACIÓN DE TU TABLA PRINCIPAL MANGA
CREATE TABLE MANGA (
    ...
    -- Creación de las llaves foráneas según tu Java
...
-- Insertamos un manga conectando los ID de los datos de arriba
