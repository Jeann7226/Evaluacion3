...
-- Asegúrate de usar el nombre de columna correcto que definiste en el CREATE
INSERT INTO demografia (nombreDemografia) VALUES ('Shonen'), ('Seinen'), ('Shojo');
